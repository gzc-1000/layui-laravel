...
<div class="x-body">
    <form class="layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_email" name="cate_title" required=""
                       autocomplete="off" class="layui-input" value="{{ $cate->cate_title }}">
                <input type="hidden" value="{{ $cate->cate_id }}" name="cate_id">
            </div>
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_email" value="{{ $cate->cate_title }}" name="cate_title" required=""
