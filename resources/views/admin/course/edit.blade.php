        ...
        <form class="layui-form">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  ...
                  <input type="text" id="L_email" value="{{ $course->c_name }}" name="c_name" required="" 
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_email" value="{{ $course->point }}" name="point" required="number" 
                  autocomplete="off"  class="layui-input">
              </div>
          </div>
          ...
          <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <script id="editor" class="detail" type="text/plain" name="dec"  style="width:940px;height:300px;">
                          {!!$course->descript!!}</script>
                      </div>
                  </div> 
